    ...
    return (
        ...
        <Layout>
            <div className="container" >
                <div className='offers my-2'  style={{border:'1px solid #008ECC',borderRadius:'10px'}}  >
                <div className='card-header'
                 style={{display:'flex', alignItems:'center', justifyContent:'space-between'}}>
                <h6 className="mb-0">Offers on Cake </h6>
                <div>
                    <Link to="/shop" ><small>View more</small></Link>
                </div>
                </div>
            ...
            <div className=' container offers'>
                <div className='card-header'
                     style={{display:'flex', alignItems:'center', justifyContent:'space-between',border:'3px solid #008ECC',borderRadius:'13px'}}>
                ...
                <div className=' my-2 ' >
                    {!productsBySell.length? (showLoading()):(
